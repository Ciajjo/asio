...
const uint32_t TableStruct_demo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::hello::HelloRequest, _impl_.message_),
  ~0u,  // no _has_bits_
...
const ::_pbi::DescriptorTable descriptor_table_demo_2eproto = {
    false, false, 162, descriptor_table_protodef_demo_2eproto,
    "demo.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "hello.HelloRequest.message"));
        } else
          goto handle_unusual;
        continue;
      default:
